...
- **Unique Authors**: 189
- **Research Fields**: 4
- **Last Updated**: 2025-12-15 08:39:00
...
The construction of adversarial attacks for neural networks appears to be a crucial challenge for their deployment in various services. To estimate the adversarial robustness of a neural network, a fast and efficient approach is needed to construct adversarial attacks. Since the formalization of adv...

### [Bidirectional Normalizing Flow: From Data to Noise and Back](/cs/lg/2512.10953-bidirectional-normalizing-flow-from-data-to-noise.md)
**Yiyang Lu, Qiao Sun, Xianbang Wang et al.** · arXiv:2512.10953 · 2025-12-11 · `cs-lg`
...
### [Extrapolation of Periodic Functions Using Binary Encoding of Continuous Numerical Values](/cs/lg/2512.10817-extrapolation-of-periodic-functions-using-binary-e.md)
